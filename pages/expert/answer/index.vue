  ...
  <div class="wrap">
    ...
    <div class="content">
      <div class="test3">
        ...
        <div class="choosediv">
          <div class="choosediv2" @click="activeTab=!activeTab">
            ...
            <u-icon v-if="!activeTab" color="#C4C7CC" size="18" name="arrow-down"></u-icon>
          ...
          <div class="select" v-if="activeTab">
            <!-- <div class="topicon">
              <u-icon color="#fff" size="18" name="arrow-up-fill"></u-icon>
                ...
                <div @click="chooseOne(item)" class="selectchild" v-for="(item,index) in select" :key="index">
                  {{item.name}}
                </div>
          </div>
        </div>
      ...
      <div class="wzdiv">
        ...
        <div class="zt">
          <div>
            状态: <span class="ztspan">已提交，待回复</span>
          </div>
          <div class="ztbtn">
            编辑
          </div>
